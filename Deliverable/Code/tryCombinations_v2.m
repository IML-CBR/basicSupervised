function [w_best, w_total, js_total, best_combination] = tryCombinations_v2(x, y, learning_rate, max_iterations, tolerance);
        ...
        for j = 1:max_it_size
            for k = 1:toler_size
                [w_total{num_iter},js_total{num_iter}] = ...
                    descentLinearRegression_v2(x,y,learning_rate(i),...
